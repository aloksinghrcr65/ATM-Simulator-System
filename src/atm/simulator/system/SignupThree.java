...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        c7 = new JCheckBox("I hereby declares that the above entered details correct to the best of my knowledge.",false);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(accountType.equals("") || facility.isEmpty()){
                    JOptionPane.showMessageDialog(null, "Please Fill all the required fields");
                }else if (!c7.isSelected()) {
                     JOptionPane.showMessageDialog(null, "Please agree to the declaration before submitting the form.");
                }else{
                    String encryptedPin = encrypt(pin);
                    Conn c1 = new Conn();
                    String query1 = "insert into signupthree values('"+formno+"','"+accountType+"','"+cardNumber+"','"+encryptedPin+"','"+facility+"')";  
//                      String query1 = "insert into signup3 values('"+formno+"','"+accountType+"','"+cardNumber+"','"+pin+"','"+facility+"')";  
                      String query2 = "insert into login values('"+formno+"','"+cardNumber+"','"+encryptedPin+"')";
//                      String query2 = "insert into login1 values('"+formno+"','"+cardNumber+"','"+pin+"')";
