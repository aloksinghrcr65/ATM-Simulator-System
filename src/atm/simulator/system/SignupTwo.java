...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String income[] = {"Select","0","<1,50,000","<2,50,000","<5,00,000","Upto 10,00,000","Above 10,00,000"};
    ...
    if(religion.equals("Select") && category.equals("Select") && income.equals("Select") && education.equals("Select")
            && occupation.equals("Select") && t1.getText().isEmpty() && t2.getText().isEmpty()) {
        ...
        JOptionPane.showMessageDialog(null,"Please Choose Your Income");
    }else if(education.equals("Select")){
        JOptionPane.showMessageDialog(null, "Please Select Your Education");
    }else if(occupation.equals("Select")){
        JOptionPane.showMessageDialog(null, "Please Select Your Occuption");
